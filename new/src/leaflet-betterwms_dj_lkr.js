...
/*    $.ajax({
  ...
  getFeatureInfoUrl: function (latlng) { this._map=this._map||karte  //work if layer disabled
    ...
    var point = this._map.latLngToContainerPoint(latlng, this._map.getZoom()),
        ...
        params = {
          ...
          propertyName: 'EVENT,ONSET,EXPIRES,SENT,SEVERITY,EC_GROUP,AREADESC',  //,SEVERITY,EC_GROUP
  ...
  showGetFeatureInfoJson: function (latlng, data) {
    ...
    content += "<a target='dwd' href='https://www.dwd.de/warnungen'>dwd.de</a> "+new Date(data.features[0].properties.SENT).toLocaleTimeString('de',{hour:"2-digit",minute:"2-digit"})+" "+data.features[0].properties.AREADESC;
