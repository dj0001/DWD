...
//more addons
var dt=0; warnlayer._marker.on('move', function(e){ var data=warnlayer._data  // =qs?0:1
     if(data.features.length){  //console.log(dt)  //add notification
...
L.Control.Watermark = L.Control.extend({ //image for geocode (OpenStreetMap)
  onAdd: function(map) {
    ...
    img.setAttribute("class", "leaflet-control-layers")  //img.style.background = 'white';
